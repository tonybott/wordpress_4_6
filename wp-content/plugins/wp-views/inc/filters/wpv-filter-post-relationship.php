...
class WPV_Post_Relationship_Filter {
    ...
    static function init() {
		wp_register_script( 'views-filter-post-relationship-js', ( WPV_URL . "/res/js/filters/views_filter_post_relationship.js" ), array( 'suggest', 'views-filters-js'), WPV_VERSION, true );
		$pr_strings = array(
			'post'		=> array(
