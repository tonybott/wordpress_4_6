...
<?php
   ...
   public function display_banner() {
	 ...
	 */
	function get_remote_info( $url, $refresh = true ) {
		...
		if ( $refresh || ( $info = get_transient( '_wp_sh_plugin_browser-list-info' ) ) === false ) {
			...
			set_transient( '_wp_sh_plugin_browser-list-info', $info, 60 * 60 * 24 );
		}
		return $info;
	}
...
<?php
	 ...
	 */
	public function update_plugins( $value, $transient, $refresh = true ) {
		$this->get_plugins( $refresh );
		return $value;
	}
